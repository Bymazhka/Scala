...
object Typeclasses {//классы определяют абстракцию дя различных типов и реализацию для конкретных
  ...
  object ReversableString extends Reversable[String] {
  ...
  object Smash {
    object SmashInt extends Smash[Int] {
      def smash(a: Int, b: Int): Int = a + b
    }

    object SmashDouble extends Smash[Double] {
    ...
    object SmashString extends Smash[String] {
